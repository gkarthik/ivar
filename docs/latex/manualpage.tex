\hypertarget{manualpage_autotoc_md13}{}\section{Available Commands}\label{manualpage_autotoc_md13}
\tabulinesep=1mm
...
To view detailed usage for each command type {\ttfamily ivar $<$command$>$} Note \+: Commands maked (E\+X\+P\+E\+R\+I\+M\+E\+N\+T\+AL) are still under active development.\hypertarget{manualpage_autotoc_md14}{}\section{Description of commands}\label{manualpage_autotoc_md14}
\hypertarget{manualpage_autotoc_md15}{}\subsection{Trim primer sequences with i\+Var}\label{manualpage_autotoc_md15}
...
Example Usage\+: 
\begin{DoxyCode}
samtools mpileup -A -d 600000 -F 0 -B -Q 0 test.trimmed.bam | ivar variants -p test -q 20 -t 0.03 -r
...
\end{longtabu}
\hypertarget{manualpage_autotoc_md18}{}\subsection{Generate a consensus sequences from an aligned B\+A\+M file}\label{manualpage_autotoc_md18}
...
The command above will produce a test.\+fa fasta file with the consensus sequence and a test.\+qual.\+txt with the average quality of each base in the consensus sequence.\hypertarget{manualpage_autotoc_md19}{}\subsection{Get primers with mismatches to the reference sequence}\label{manualpage_autotoc_md19}
...
1 2 7 8
\end{DoxyCode}
\hypertarget{manualpage_autotoc_md20}{}\subsection{Remove reads associated with mismatched primer indices}\label{manualpage_autotoc_md20}
