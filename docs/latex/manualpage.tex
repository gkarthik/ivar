\hypertarget{manualpage_autotoc_md10}{}\section{Available Commands}\label{manualpage_autotoc_md10}
\tabulinesep=1mm
...
To view detailed usage for each command type {\ttfamily ivar $<$command$>$} Note \+: Commands maked (E\+X\+P\+E\+R\+I\+M\+E\+N\+T\+AL) are still under active development.\hypertarget{manualpage_autotoc_md11}{}\section{Description of commands}\label{manualpage_autotoc_md11}
\hypertarget{manualpage_autotoc_md12}{}\subsection{Trim primer sequences with i\+Var}\label{manualpage_autotoc_md12}
...
.
\end{DoxyCode}
\hypertarget{manualpage_autotoc_md13}{}\subsection{Call variants with i\+Var}\label{manualpage_autotoc_md13}
...
\end{longtabu}
\hypertarget{manualpage_autotoc_md15}{}\subsection{Generate a consensus sequences from an aligned B\+A\+M file}\label{manualpage_autotoc_md15}
...
The command above will produce a test.\+fa fasta file with the consensus sequence and a test.\+qual.\+txt with the average quality of each base in the consensus sequence.\hypertarget{manualpage_autotoc_md16}{}\subsection{Get primers with mismatches to the reference sequence}\label{manualpage_autotoc_md16}
...
1 2 7 8
\end{DoxyCode}
\hypertarget{manualpage_autotoc_md17}{}\subsection{Remove reads associated with mismatched primer indices}\label{manualpage_autotoc_md17}
